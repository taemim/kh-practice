...
SELECT 
       DEPARTMENT_NAME ||'과의 정원은 '|| CAPACITY ||'명 입니다.'
  FROM TB_DEPARTMENT;
...
SELECT 
  ...
  FROM TB_STUDENT
 WHERE ABSENCE_YN = 'N'
   AND TO_CHAR(ENTRANCE_DATE,'RRRR') = '2002' 
   AND STUDENT_ADDRESS LIKE '전주%';

-- 11. 입사년도를 BETWEEN AND로 날짜안에 있는지 조회하는 방법
SELECT 
       STUDENT_NO
     , STUDENT_NAME
     , STUDENT_SSN
